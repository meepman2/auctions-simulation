        ...
        <div>
            <ReactMapGL
                ...
                {artifactData.artifacts.map(artifact => {
                    ...
                    return (<Marker key={artifact.name} latitude={artifact.geometry.coordinates[1]} longitude={artifact.geometry.coordinates[0]}>
                        <svg
                            height={SIZE}
                            viewBox="0 0 24 24"
                            style={{
                ...
                {selectedArtifact ? (
                    <CardPopup selectedArtifact={selectedArtifact} handleCloseArtifact={handleCloseArtifact} />
                ) : null}
            </ReactMapGL>
        </div>
    );
